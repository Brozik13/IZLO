...
;   counting amount of portions
(assert 
    (and
        (<= 0 n1 m1) (<= 0 n2 m2) (<= 0 n3 m3) (<= 0 n4 m4) (<= 0 n5 m5)
    )
)

;   Get default prices and calculate maximum prices
(assert
    (<=
        (+
...
(assert 
    (not    
        (exists ((x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Int))
            (and
                (<= 0 x1 m1) (<= 0 x2 m2) (<= 0 x3 m3) (<= 0 x4 m4) (<= 0 x5 m5)
                (<= (+ (* c1 x1) (* c2 x2) (* c3 x3) (* c4 x4) (* c5 x5)) max_cena)
                (> (+ (* k1 x1) (* k2 x2) (* k3 x3) (* k4 x4) (* k5 x5)) best)
            )
        )   
    )       
)
